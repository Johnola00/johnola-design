...
export function Footer() {
  return (
    <footer className="relative mt-[100px] flex h-[385px] w-full items-center justify-center border-t border-white/20 max-md:h-auto">
      <div className="relative mx-auto flex h-full w-full max-w-[1440px] flex-row items-center justify-between px-[80px] py-[60px] max-md:flex-col max-md:items-stretch max-md:gap-10 max-md:px-5 max-md:py-10">
        <div className="flex flex-col">
          <p className="text-[26px] leading-none font-medium text-white">
            John Oduntan
          </p>

          <div className="mt-[28px] flex flex-row items-center gap-[12px] max-md:flex-wrap">
        ...
        <div className="absolute top-1/2 left-1/2 flex -translate-x-1/2 -translate-y-1/2 flex-col gap-[12px] max-md:static max-md:translate-x-0 max-md:translate-y-0">
        ...
        <div className="flex h-full flex-col items-end justify-between max-md:h-auto max-md:items-start max-md:gap-10">
          <button
            type="button"
